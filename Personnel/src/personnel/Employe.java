...
public class Employe implements Serializable, Comparable<Employe>
{
	...
	public void setDateArrivee(LocalDate dateArrivee){  //Setter pour la date d'arriv�e
	...
	public void setDateDepart(LocalDate dateDepart){  //Setter pour la date de d�part

...
class testEmploye {
   ...
   void getPrenom() throws SauvegardeImpossible{
          ...
          Employe employe = ligue.addEmploye("John", "Doe", "Johndoe@mail.com", "admin", null, null, 0);
   ...
   void isRoot() throws SauvegardeImpossible{
          ...
          Employe employe2 = ligue.addEmploye("John", "Doe", "Johndoe@mail.com", "admin", null, null, 0);
   ...
   void compareTo() throws SauvegardeImpossible{
	      Ligue ligue = gestionPersonnel.addLigue("ligueOne");
          Employe premierEmploye = ligue.addEmploye("John", "Doe", "Johndoe@mail.com", "admin", null, null, 0);
          Employe deuxiemeEmploye = ligue.addEmploye("Gareth", "Bale", "Garethbale@mail.com", "admin2", null, null, 0);
          assertTrue(deuxiemeEmploye.compareTo(premierEmploye)<0);
   }
   ...
   void getDateDepart() throws SauvegardeImpossible{
	   Ligue ligue = gestionPersonnel.addLigue("ligueOne");
       Employe employe = ligue.addEmploye("John", "Doe", "Johndoe@mail.com", "admin", LocalDate.parse("2018-12-30"), LocalDate.parse("2018-12-28"), 0);
